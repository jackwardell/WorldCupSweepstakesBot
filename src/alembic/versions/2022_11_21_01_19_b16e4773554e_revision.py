...
Revision ID: b16e4773554e
Revises: 
Create Date: 2022-11-21 01:19:32.643329
...
def upgrade() -> None:
    ...
    op.create_table('team_participant_association',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('team_name', sa.String(), nullable=False),
    sa.Column('participant_name', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['participant_name'], ['participant.name'], ),
